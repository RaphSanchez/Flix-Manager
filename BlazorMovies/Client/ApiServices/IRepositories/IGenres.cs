...
namespace BlazorMovies.Client.ApiServices.IRepositories
{
    ...
    /// </para>
    /// </remarks>
    public interface IGenres : IRepository<Genre>
    {
        ...
        /// values extracted from the GenresQueryFilterDto passed to satisfy
        ...
        /// </para>
        /// </remarks>
        /// <param name="genresQueryFilterDto">The DTO that encapsulates 
        /// property values that can be directly related to one or more 
        /// properties of a type Genre.</param>
        ...
        Task<IEnumerable<Genre>> FilterAsync(
            GenresQueryFilterDto genresQueryFilterDto);
