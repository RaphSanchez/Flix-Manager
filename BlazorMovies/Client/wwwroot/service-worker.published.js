...
// Handles web push event notifications; i.e., it displays de notification.
        ...
        self.registration.showNotification('New Movie in Theaters!',
            {
                ...
                body: payload.title,
                image: payload.image,
                // 'data' encapsulates any arbitrary data that should be passed
                // when the notification is clicked. In our example, it passes
                // a 'url' property which is used by the 'notificationclick' 
                // event handler below.
                data: { url: payload.url },
                // 'requireInteraction' property returns a boolean value 
                // indicating that a notification should remain active until 
                // the user clicks or dismisses it, rather than closing
                // automatically. 
